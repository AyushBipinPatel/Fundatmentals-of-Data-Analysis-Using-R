...
<img src = "https://raw.githubusercontent.com/rstudio/hex-stickers/master/thumbs/tidyr.png" width = 150px>
<br>
...
.pull-left[
[Background image:  Plums by John William Hill](https://images.metmuseum.org/CRDImages/ad/original/DT202023.jpg)<br>
[The tidyr hex logo is from RStudio github page](https://raw.githubusercontent.com/rstudio/hex-stickers/master/thumbs/tidyr.png)
]
...
You know __basics of data wrangling__
<br>
...
#### Seperating rows and columns

#### Handle Missing values

#### Create tables with combination of values
...
Go to the project `Your Turn - Lecture 8`

Open a file named `exercise for lecture 8.Rmd`
...
```{r include=FALSE}
tibble(
  name = c("Saswata","Saswata","Saswata","Ayush"),
  dish = c("Biryani","Mutton Curry", "Fish Fry", "Biryani"),
  rating = c(8,9,7,7)
...
.panel[.panel-name[Complete the data]
...
.panel[.panel-name[Creating combinations]

```
Say we have 5 individuals who go to try 2 food items in Kolkata.

How to create a table with all combinations
```
